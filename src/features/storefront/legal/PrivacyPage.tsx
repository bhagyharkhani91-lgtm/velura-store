    ...
    <Container className="legal-page">
      ...
      <div className="legal-content">
        <section>
          ...
          <p>
            At VELURA, we take your privacy and discretion extremely seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make a purchase.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your privacy is our top priority. All charges on your credit card statement will appear under a discreet corporate name, not "VELURA". All packages are shipped in plain, unmarked boxes with no logos or descriptions of the contents on the outside.
          </p>
        </section>
